...
this.mmooc.youtube = function() {
	...
	function transcript(transcriptId, language, name)
	{
		...
		this.transcriptLoaded = function(transcript) {
			...
			var srt_output = "<div class='btnSeek' id='btnSeek' data-seek='0'></div>";
			...
			for (var i = 0, il = captions.length; i < il; i++) {
				...
				srt_output += "<div class='btnSeek' data-seek='" + start + "' id='" + timestampId + "'>" + captionText + "</div> ";
			};
